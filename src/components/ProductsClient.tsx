...
export default function ProductsClient({ products }: ProductsClientProps) {
  ...
  const getCurrentPrice = (product: Product) => {
    ...
    return selectedWeight ? selectedWeight.price : product.priceUsd
  }
                      ...
                      {product.galleryImages && product.galleryImages.length > 1 && (
                        <>
                          <button
                            onClick={(e) => {
                              e.preventDefault()
                              handleImageClick(product.id, currentImageIndex > 0 ? currentImageIndex - 1 : product.galleryImages!.length - 1)
                            }}
                          ...
                          <button
                            onClick={(e) => {
                              e.preventDefault()
                              handleImageClick(product.id, currentImageIndex < product.galleryImages!.length - 1 ? currentImageIndex + 1 : 0)
                            }}
