      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-900">Nuevo Lote de Café</h1>
              <p className="text-gray-600 mt-1">Registra un nuevo lote para trazabilidad</p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-1">
                      Código de Lote * <span className="text-xs text-gray-600">(ej: AR000147)</span>
                    </label>
                    <input
                      type="text"
                      name="batch_id"
